...
module Contacts
  ...
  # 
  #   Contacts::GoogleAuthSub.authentication_url('http://mysite.com/invite')
  #
  ...
  #
  #   gmail = Contacts::GoogleAuthSub.new(params[:token])
  #   gmail.contacts
  #   # => [#<Contact 1>, #<Contact 2>, ...]
  #
  ...
  # doesn't expire:
  # 
  #   Contacts::GoogleAuthSub.authentication_url('http://mysite.com/invite', :session => true)
  #
  ...
  #
  #   token = Contacts::GoogleAuthSub.sesion_token(params[:token])
  #
